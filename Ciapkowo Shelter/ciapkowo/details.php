...
<head>
    ...
    <title>Ciapkowo - Więcej informacji o zwierzaku</title>
...
if(isset($_GET['ID'])){
    ...
    $sql = 'SELECT * FROM zwierzaki WHERE id='.$_GET['ID'];
    ...
    <h1><div id="formatsuper"> '.$row["imie"].'</div></h1>
        ...
        <h2><p> INFORMACJE O ZWIERZAKU</p></h2> 
            ...
            <div class="">
             <img id="detalZDJ" style="height: 10%;" src="admin/'.$row['zdjecie'].'">
            </div>
